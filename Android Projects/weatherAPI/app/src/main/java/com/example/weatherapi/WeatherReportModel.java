...
public class WeatherReportModel {
    ...
    public WeatherReportModel(int id, String weather_state_name, String wind_direction_compass, String created, String applicable_date, float min_temp, float max_temp, float the_temp, float wind_speed, float wind_direction, int air_pressure, int humidity, float visibility, float predictability) {
        this.id = id;
